    ...
    <div style="margin-top:40px;text-align:center;">
      ...
      <div class="form-group">
        <select name="s_jurusan" id="s_jurusan" class="form-control">
          <option value="">Filter Kursus yang diinginkan :</option>
          <option value="Sistem Informasi">SD</option>
          <option value="Teknik Informatika">SMP</option>
          <option value="Teknik Informatika">SMA/SMK</option>
          <option value="Teknik Informatika">SBPTN</option>
          <option value="Teknik Informatika">MENGGAMBAR</option>
          <option value="Teknik Informatika">MEWARNAI</option>
          <option value="Teknik Informatika">MENGAJI</option>
          <option value="Teknik Informatika">BAHASA INGGRIS</option>
          <option value="Teknik Informatika">BAHASA JEPANG</option>
        </select>
      </div>
      <input id="pac-input" class="form-control" type="text" value="<?= $kota_temp; ?>" placeholder="Masukkan Alamat" onchange="getArea()" />
