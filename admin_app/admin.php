...
<head>
  ...
  <title>Flash School - Halaman Administrator</title>
...
<body style="font-family: 'Nunito Sans';">
  <div id="app">
      ...
      <nav class="navbar navbar-expand-lg main-navbar" id='divNavbar'>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">Hi, <?= $_SESSION["user_login"]; ?> - Administrator Website</div>
            </a>
    ...
    <script src="../ladun/dasbor/admin_dashboard.js"></script>
</body>
