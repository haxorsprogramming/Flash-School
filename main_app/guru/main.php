...
<!DOCTYPE html>
 ...
 <head>
   ...
   <title>Flash School - Halaman Guru</title>
 ...
 <body style="font-family: 'Nunito Sans';">
       ...
       <nav class="navbar navbar-expand-lg main-navbar" id="divNavbar">
         ...
         <ul class="navbar-nav navbar-right">
           ...
           <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
             ...
             <div class="d-sm-none d-lg-inline-block">Hi, <?=$_SESSION["user_login"]; ?> - Guru</div></a>
       ...
       <div class="main-sidebar" id="divMenu">
        <aside id="sidebar-wrapper">
            ...
            <ul class="sidebar-menu" style="margin-top:20px;">
              ...
              <li><a class="nav-link" @click="profileAtc()" href="#!"><i class="fas fa-user-circle"></i><span>Profil</span></a></li>
              <li><a class="nav-link" @click="dataPemesananAtc()" href="#!"><i class="far fa-clipboard"></i><span>Data Pemesanan</span></a></li>
              <li><a class="nav-link" @click="tentoringSayaAtc()" href="#!"><i class="fas fa-certificate"></i><span>Tentoring Saya</span></a></li>
   ...
   <script src="<?=$base_url; ?>ladun/dasbor/stisla/js/stisla.js"></script>
      ...
      <script src="<?=$base_url; ?>ladun/dasbor/guru_dashboard.js"></script>
 </body>
 </html>